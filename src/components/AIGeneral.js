...
function AIGeneral(props) {
    ...
    return (
        <div style={{
            ...
            <div 
            style={{  padding: '15px'}}
            dangerouslySetInnerHTML={{__html: loadingAiRes === null ? '<span style="color: grey;">AI output will be shown here :<br/><br/></span>' : loadingAiRes === true ? '<span>Loading...</span>' : aiRes}}
            > 
            </div> 
